...
python -u train.py --name raft-combined --stage combined --validation combined --restore_ckpt models/raft-things.pth --gpus 0 --num_steps 100000 --batch_size 6 --lr 0.000125 --image_size 368 768 --wdecay 0.00001 --gamma=0.85
