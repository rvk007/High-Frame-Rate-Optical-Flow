...
class Logger:
    ...
    def _print_training_status(self):
        ...
        print('training_str: ', training_str)
        print('self.running_loss: ', self.running_loss)
        # print the training status
        loguru_logger.info(training_str + metrics_str)
        # training_str: self.total_steps+1, self.scheduler.get_last_lr()
        # metrics_str: 10-th-5px, 1px, 20-th-5px, 3px, 5-th-5px, 5px, epe
