...
class MpiSintel(FlowDataset):
    def __init__(self, aug_params=None, split='training', root='datasets/Sintel', dstype='clean'):
        ...
        # new method to load more than 2 images
        self.image_list, self.flow_list = [], []
        frame_path = '/scratch/rr3937/optical_flow/FlowFormer-Official/datasets/data'
        ...
        for scene in os.listdir(frame_path):
            ...
            i = 0
            for img1, img2, img3 in zip(images[0::1], images[1::1], images[2::1]):
                i += 1
                self.image_list.append([img1.strip(), img2.strip(), img3.strip()])
                if i == 2:
                    break
            i = 0
            for flo in flow[2::1]:
