...
python /scratch/rr3937/optical_flow/BlenderProc/examples/advanced/optical_flow/generate_frame_gt.py --path /scratch/rr3937/optical_flow/BlenderProc/examples/advanced/optical_flow/output/combined
```
...
-10 -> -20 took camera far away in -y direction from object
4 -> 10 took camera far away in +z direction from object
4 -> 2 took camera far away in -z direction from object
0 -> -2 took camera far away in -x direction from object